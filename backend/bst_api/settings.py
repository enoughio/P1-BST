...
# Gunicorn ya koi production WSGI server .env file ko khud se load nahi karta.
# Ye make sure karega ki .env file load ho jaye even if you're not using manage.py.
...
TIME_ZONE = 'Asia/Kolkata' # for INDIA time
