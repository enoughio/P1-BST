...
const Header = () => {
  return (
    <header className="mt-10 md:mt-16">
      <div className="relative overflow-hidden rounded-3xl border border-[#E7DCCF] bg-gradient-to-br from-[#F6EFE5] via-white to-[#E6EFF7] px-6 py-10 shadow-sm md:px-10">
        <div className="absolute -left-10 top-6 h-28 w-28 rounded-full bg-[#E8D8C6] blur-3xl opacity-70" />
        <div className="absolute -right-10 bottom-0 h-32 w-32 rounded-full bg-[#D7E3F3] blur-3xl opacity-60" />
