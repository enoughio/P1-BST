...
export function WhyChooseUs() {
  return (
    <section className="mx-auto my-8 flex w-full flex-col gap-8 md:w-[93%]">
      <div className="relative overflow-hidden rounded-[36px] border border-[#E7DCCF] bg-gradient-to-br from-[#F6EFE5] via-white to-[#E6EFF7] px-6 py-12 shadow-sm sm:px-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(234,217,200,0.7),transparent_55%),radial-gradient(circle_at_85%_0%,rgba(214,226,243,0.7),transparent_50%)]" />
        <div className="relative grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="rounded-2xl border border-white/70 bg-gradient-to-br from-white via-white/90 to-[#E6EFF7]/70 p-4 text-sm text-[#5B4E44] shadow-sm"
                >
          ...
          <div className="grid gap-4">
            <div className="rounded-2xl border border-[#EFE4D6] bg-gradient-to-br from-white via-white/90 to-[#EAD9C8]/60 p-6 shadow-sm">
            ...
            <div className="rounded-2xl border border-[#EFE4D6] bg-gradient-to-br from-white via-white/90 to-[#E6EFF7]/70 p-6 shadow-sm">
      ...
      <div className="rounded-3xl border border-[#E7DCCF] bg-gradient-to-br from-[#EAD9C8]/50 via-white to-[#E6EFF7]/60 p-6 shadow-sm">
        <CoachingCarousel />
      </div>
    </section>
  );
