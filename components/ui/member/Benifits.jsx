...
const MembershipBenefits = () => {
  ...
  return (
    <section className="py-8 px-4 md:px-12 bg-gradient-to-b from-white to-gray-50 ">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mt-8 mb-2 text-center">
          <a 
            href="/findaclub" 
            className="inline-flex items-center bg-blue-500 text-white px-6 py-3 rounded-lg font-medium transition-all hover:bg-blue-700 hover:shadow-lg"
          >
            Find A Club
