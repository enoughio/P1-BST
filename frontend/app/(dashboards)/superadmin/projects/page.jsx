...
export default function SuperAdminProjectsPage() {
        ...
        const mockProjects = [
          {
            ...
            title: "Ice Breaker",
            description:
              "First speech project focusing on introducing yourself to the club",
            level: "Level 1",
            assignedTo: {
              id: "4",
              name: "Diana Miller",
            ...
            feedback:
              "Great first speech! Effectively introduced yourself and showed your enthusiasm.",
          ...
          },
          {
            ...
            description:
              "Research a topic, organize supporting materials, and deliver a well-organized speech",
            level: "Level 2",
            assignedTo: {
              id: "2",
              name: "Bob Smith",
          ...
          },
          {
            ...
            description:
              "Practice using language that shows positivity in your speech",
            level: "Level 3",
            assignedTo: {
              id: "1",
              name: "Alice Johnson",
            ...
            feedback:
              "Excellent use of positive language. Very motivational and uplifting.",
          ...
          },
          {
            ...
            description:
              "Practice storytelling techniques to connect with your audience",
            level: "Level 2",
            assignedTo: null,
            status: "Not Started",
            completedDate: null,
          ...
          },
          {
            ...
            title: "Vocal Variety",
            description:
              "Learn to use voice modulation effectively in your speeches",
            level: "Level 2",
            assignedTo: {
              id: "5",
              name: "Edward Garcia",
            ...
            feedback:
              "Good use of vocal variety. Work on pauses for dramatic effect.",
            program: { id: "3", name: "Storytellers" },
          },
        ];
  ...
  useEffect(() => {
    if (data) {
      ...
      if (selectedClub) {
        filtered = filtered.filter(
          (project) =>
            project.assignedTo && project.assignedTo.clubId === selectedClub
        );
      }
      ...
      if (selectedProgram) {
        filtered = filtered.filter(
          (project) => project.program && project.program.id === selectedProgram
        );
      }
  ...
  const newLocal = <div className="w-full md:w-64">
    <Select
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-gray-500">
                Manage projects across all clubs in the organization
              </p>
            </div>
                          ...
                          <TableRow key={project.id}>
                            ...
                            <TableCell>
                              <div className="flex items-center gap-2">
                                ...
                                >
                                  <Link
                                    href={`/superadmin/projects/${project.id}/edit`}
                                  >
                                    Edit
                                  </Link>
                                </Button>
                  ...
                  {selectedProject.assignedTo && (
                    <div>
                      ...
                      <span>
                        ...
                        {selectedProject.assignedTo.clubName})
                      </span>
                    </div>
                  )}
                </div>
