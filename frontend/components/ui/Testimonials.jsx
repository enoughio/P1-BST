...
const Testimonials = () => {
  return (
    <div className="flex-col flex justify-center items-center ">
      ...
      {/* cards */}
      <div className="flex flex-row  justify-center items-center gap-2 mx-10">
        {testimonials.map((testimonial, indx) => (
          // card
          <div key={indx} className="py-5 w-[90%] md:w-1/3 flex justify-center items gap-1 border-2 rounded-2xl overflow-hidden">
