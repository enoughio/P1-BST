    ...
    <div className="flex-col flex justify-center items-center bg-blue-100 py-5">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-4 mx-10 px-3">
        {testimonials.map((testimonial, indx) => (
          ...
          <div
            key={indx}
            className="py-6 bg-white  w-full md:w-1/3 flex flex-col justify-center items-center gap-2 backdrop-blur-xl rounded-2xl overflow-hidden min-h-56"
          >
            ...
            <div className="text-center flex flex-col justify-center items-center gap-1">
                ...
                <h3 className="text-[.6rem] max-w-[60%] leading-3 ">{testimonial.handle}</h3>
              </div>
