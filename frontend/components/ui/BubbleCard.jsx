...
import { BubbleCardDetails } from "./BubbleCardDetails"; // Import the new component
  ...
  (
    {
      ...
      bold = false,
      type = "normal",
      details, // New prop for detailed description
      ...props
    },
    ref
  ) => {
    return (
      ...
      <DialogTrigger asChild>
        <div
        ref={ref}
        className={cn(cardVariants({ cardSize, className }), " hover:shadow-lg transition-transform duration-300 ease-out")}
        style={cardColor}
        {...props}
        >
