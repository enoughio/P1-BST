...
const StatCard = ({ number, label1, label2 }) => {
  return (
    <div className="relative w-20 h-20 md:w-32 md:h-32 lg:w-48 lg:h-48 rounded-full flex justify-center items-center bg-[#F7EBEC]"
        style={{background: ""}}
    >
...
const Journy = () => {
  return (
    <section className="wrapper flex flex-col items-center py-5 my-10 mt-16  bg-gradient-to-b from-[#F7EBEC]/10 to-[#F1D2D4]   overflow-hidden px-5 ">
