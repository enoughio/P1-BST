...
const StatCard = ({ number, label1, label2 }) => {
  return (
    <div className="relative w-44 h-44 bg-red-100 rounded-full flex justify-center items-center">
...
const Journy = () => {
  return (
    <div className="bg-red-200 w-full h-[40vh] flex justify-center gap-24 items-center my-5">
